...
public class ProductionConfigService {
	...
	public PackageBean getData(JSONObject body, int page, int p_size) {
		...
		if (body == null || body.isNull("search")) {
			...
			int ord = 0;
			object_header.put(FFS.ord((ord += 1), FFM.Hmb.H) + "pb_cell", FFS.h_t("SN_欄位", "100px", FFM.See.SHO));
			object_header.put(FFS.ord((ord += 1), FFM.Hmb.H) + "pb_value", FFS.h_t("SN_名稱", "100px", FFM.See.SHO));
			...
			obj_m.put(FFS.h_m(FFM.D_None.D_SOHW,FFM.Tag.SEL, FFM.Type.TEXT, "", "", FFM.See.DIS, "col-md-2", false, a_val_body, "pb_cell", "SN_欄位"));
			obj_m.put(FFS.h_m(FFM.D_None.D_SOHW,FFM.Tag.INP, FFM.Type.TEXT, "", "", FFM.See.SHO, "col-md-2", false, n_val, "pb_value", "SN_名稱"));
...
//
//			obj_m.put(FFS.h_m(FFM.D_None.D_SOHW,FFS.TTA, FFS.TEXT, "", "", FFM.See.SHO, "col-md-12", false, n_val, "sys_note", "備註"));
//			obj_m.put(FFS.h_m(FFM.D_None.D_SOHW,FFS.INP, FFS.NUMB, "0", "0", FFM.See.SHO, "col-md-2", true, n_val, "sys_sort", "排序"));
//			obj_m.put(FFS.h_m(FFM.D_None.D_SOHW,FFS.INP, FFS.NUMB, "", "", FFM.See.DIS, "col-md-2", false, n_val, "sys_ver", "版本"));

			a_val = new JSONArray();
			a_val.put((new JSONObject()).put("value", "正常").put("key", "0"));
			a_val.put((new JSONObject()).put("value", "異常").put("key", "1"));
//			obj_m.put(FFS.h_m(FFM.D_None.D_SOHW,FFS.SEL, FFS.TEXT, "", "0", FFM.See.SHO, "col-md-2", true, a_val, "sys_status", "狀態"));

...
public class ProductionConfigService {
	...
	public PackageBean getData(JSONObject body, int page, int p_size) {
		...
		if (body == null || body.isNull("search")) {
			...
			obj_m.put(FFS.h_m(FFM.Tag.SEL, FFM.Type.TEXT, "", "", FFM.See.DIS, "col-md-2", false, a_val_body, "pb_cell", "SN_欄位"));
			obj_m.put(FFS.h_m(FFM.Tag.INP, FFM.Type.TEXT, "", "", FFM.See.SHO, "col-md-2", false, n_val, "pb_value", "SN_名稱"));
...
//
//			obj_m.put(FFS.h_m(FFS.TTA, FFS.TEXT, "", "", FFM.See.SHO, "col-md-12", false, n_val, "sys_note", "備註"));
//			obj_m.put(FFS.h_m(FFS.INP, FFS.NUMB, "0", "0", FFM.See.SHO, "col-md-2", true, n_val, "sys_sort", "排序"));
//			obj_m.put(FFS.h_m(FFS.INP, FFS.NUMB, "", "", FFM.See.DIS, "col-md-2", false, n_val, "sys_ver", "版本"));

			a_val = new JSONArray();
			a_val.put((new JSONObject()).put("value", "正常").put("key", "0"));
			a_val.put((new JSONObject()).put("value", "異常").put("key", "1"));
//			obj_m.put(FFS.h_m(FFS.SEL, FFS.TEXT, "", "0", FFM.See.SHO, "col-md-2", true, a_val, "sys_status", "狀態"));
